...
export const Header = () => {
  ...
  const headerButton = (
    <Button onClickCallBack={toggleDropdown} className={`caret dropdown-button d-flex justify-content-space-between header-button`}>
    ...
    <header className="main-header bg-container border-bottom">
      <nav className="navbar container py-3">
        ...
        <Dropdown toggleButton={headerButton} isOpen={isOpen} setIsOpen={setIsOpen} position="bottom">
          ...
          <a href="#" className="dropdown-item mb-2">
